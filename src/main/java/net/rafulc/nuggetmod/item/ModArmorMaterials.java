...
public enum ModArmorMaterials implements ArmorMaterial {
    Nugget("nugget", 47, new int[]{10, 13, 15, 10}, 25, SoundEvents.ARMOR_EQUIP_LEATHER, 5.0F, 1.9F, () -> {
        return Ingredient.of(ModItems.Nugget.get());
    });
    ...
    public String getName() {
        return NuggetMod.MOD_ID + ":" + this.name;
    }
